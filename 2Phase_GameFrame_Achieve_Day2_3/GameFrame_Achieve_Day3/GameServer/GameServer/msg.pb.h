...
template<> ::pb::SyncPlayer* Arena::CreateMaybeMessage<::pb::SyncPlayer>(Arena*);
...
class SyncPlayer :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:pb.SyncPlayer) */ {
 public:
  SyncPlayer();
  virtual ~SyncPlayer();
