...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        gridLayout->addWidget(password, 1, 2, 1, 3);

        username = new QLineEdit(centralwidget);
        username->setObjectName(QString::fromUtf8("username"));

        gridLayout->addWidget(username, 0, 2, 1, 3);
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        pushButton->setText(QCoreApplication::translate("MainWindow", "\345\273\272\346\210\277", nullptr));
