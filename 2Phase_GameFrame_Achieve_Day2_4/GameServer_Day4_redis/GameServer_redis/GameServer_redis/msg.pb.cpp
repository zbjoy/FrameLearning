...
const ::PROTOBUF_NAMESPACE_ID::uint32 TableStruct_msg_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  offsetof(::pb::BroadCastDefaultTypeInternal, contecnt_),
...
const char descriptor_table_protodef_msg_2eproto[] =
  ...
  "\002 \001(\005\022\022\n\010Contecnt\030\003 \001(\tH\000\022\031\n\001P\030\004 \001(\0132\014.p"
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_msg_2eproto = {
  &descriptor_table_msg_2eproto_initialized, descriptor_table_protodef_msg_2eproto, "msg.proto", 453,
...
void BroadCast::InitAsDefaultInstance() {
  ::pb::_BroadCast_default_instance_.contecnt_.UnsafeSetDefault(
...
const int BroadCast::kContecntFieldNumber;
...
#define CHK_(x) if (PROTOBUF_PREDICT_FALSE(!(x))) goto failure
  while (!ctx->Done(&ptr)) {
    ...
    switch (tag >> 3) {
      ...
      case 3:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 26)) {
          ptr = ::PROTOBUF_NAMESPACE_ID::internal::InlineGreedyStringParserUTF8(mutable_contecnt(), ptr, ctx, "pb.BroadCast.Contecnt");
          CHK_(ptr);
        } else goto handle_unusual;
        continue;
      // .pb.Position P = 4;
  ...
  for (;;) {
    ...
    switch (::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::GetTagFieldNumber(tag)) {
      ...
      case 3: {
        if (static_cast< ::PROTOBUF_NAMESPACE_ID::uint8>(tag) == (26 & 0xFF)) {
          DO_(::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::ReadString(
                input, this->mutable_contecnt()));
          DO_(::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::VerifyUtf8String(
            this->contecnt().data(), static_cast<int>(this->contecnt().length()),
            ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::PARSE,
            "pb.BroadCast.Contecnt"));
        } else {
          goto handle_unusual;
        }
        break;
