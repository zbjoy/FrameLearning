...
class BroadCast :
 ...
 public:
  ...
  // string Contecnt = 3;
  private:
  bool has_contecnt() const;
  public:
  void clear_contecnt();
  static const int kContecntFieldNumber = 3;
  const std::string& contecnt() const;
  void set_contecnt(const std::string& value);
  void set_contecnt(std::string&& value);
  void set_contecnt(const char* value);
  void set_contecnt(const char* value, size_t size);
  std::string* mutable_contecnt();
  std::string* release_contecnt();
  void set_allocated_contecnt(std::string* contecnt);
 ...
 private:
  ...
  union DataUnion {
    DataUnion() {}
    ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr contecnt_;
    ::pb::Position* p_;
    ::PROTOBUF_NAMESPACE_ID::int32 actiondata_;
  } Data_;
  mutable ::PROTOBUF_NAMESPACE_ID::internal::CachedSize _cached_size_;
...
// int32 Pid = 1;
inline void MovePackage::clear_pid() {
  pid_ = 0;
}
inline ::PROTOBUF_NAMESPACE_ID::int32 MovePackage::pid() const {
  // @@protoc_insertion_point(field_get:pb.MovePackage.Pid)
  return pid_;
}
inline void MovePackage::set_pid(::PROTOBUF_NAMESPACE_ID::int32 value) {
  
  pid_ = value;
  // @@protoc_insertion_point(field_set:pb.MovePackage.Pid)
}
...
// string Contecnt = 3;
inline bool BroadCast::has_contecnt() const {
  return Data_case() == kContecnt;
}
inline void BroadCast::set_has_contecnt() {
  _oneof_case_[0] = kContecnt;
}
inline void BroadCast::clear_contecnt() {
  if (has_contecnt()) {
    Data_.contecnt_.DestroyNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
    clear_has_Data();
  }
}
inline const std::string& BroadCast::contecnt() const {
  // @@protoc_insertion_point(field_get:pb.BroadCast.Contecnt)
  if (has_contecnt()) {
    return Data_.contecnt_.GetNoArena();
  }
  return *&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited();
}
inline void BroadCast::set_contecnt(const std::string& value) {
  // @@protoc_insertion_point(field_set:pb.BroadCast.Contecnt)
  if (!has_contecnt()) {
    clear_Data();
    set_has_contecnt();
    Data_.contecnt_.UnsafeSetDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
  }
  Data_.contecnt_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), value);
  // @@protoc_insertion_point(field_set:pb.BroadCast.Contecnt)
}
inline void BroadCast::set_contecnt(std::string&& value) {
  // @@protoc_insertion_point(field_set:pb.BroadCast.Contecnt)
  if (!has_contecnt()) {
    clear_Data();
    set_has_contecnt();
  ...
  Data_.contecnt_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::move(value));
  // @@protoc_insertion_point(field_set_rvalue:pb.BroadCast.Contecnt)
}
inline void BroadCast::set_contecnt(const char* value) {
  GOOGLE_DCHECK(value != nullptr);
  if (!has_contecnt()) {
    clear_Data();
    set_has_contecnt();
  ...
  Data_.contecnt_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      ::std::string(value));
  // @@protoc_insertion_point(field_set_char:pb.BroadCast.Contecnt)
}
inline void BroadCast::set_contecnt(const char* value, size_t size) {
  if (!has_contecnt()) {
    clear_Data();
    set_has_contecnt();
    Data_.contecnt_.UnsafeSetDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
  }
  Data_.contecnt_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::string(
      reinterpret_cast<const char*>(value), size));
  // @@protoc_insertion_point(field_set_pointer:pb.BroadCast.Contecnt)
}
inline std::string* BroadCast::mutable_contecnt() {
  if (!has_contecnt()) {
    clear_Data();
    set_has_contecnt();
    Data_.contecnt_.UnsafeSetDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
  }
  // @@protoc_insertion_point(field_mutable:pb.BroadCast.Contecnt)
  return Data_.contecnt_.MutableNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
}
inline std::string* BroadCast::release_contecnt() {
  // @@protoc_insertion_point(field_release:pb.BroadCast.Contecnt)
  if (has_contecnt()) {
    clear_has_Data();
    return Data_.contecnt_.ReleaseNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
  } else {
    return nullptr;
  }
}
inline void BroadCast::set_allocated_contecnt(std::string* contecnt) {
  if (has_Data()) {
    clear_Data();
  }
  if (contecnt != nullptr) {
    set_has_contecnt();
    Data_.contecnt_.UnsafeSetDefault(contecnt);
  }
  // @@protoc_insertion_point(field_set_allocated:pb.BroadCast.Contecnt)
}
