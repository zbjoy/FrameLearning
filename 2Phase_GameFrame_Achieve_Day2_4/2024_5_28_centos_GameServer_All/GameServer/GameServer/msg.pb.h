...
class Talk :
 ...
 public:
  ...
  // string Contect = 1;
  void clear_contect();
  static const int kContectFieldNumber = 1;
  const std::string& contect() const;
  void set_contect(const std::string& value);
  void set_contect(std::string&& value);
  void set_contect(const char* value);
  void set_contect(const char* value, size_t size);
  std::string* mutable_contect();
  std::string* release_contect();
  void set_allocated_contect(std::string* contect);
 ...
 private:
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::InternalMetadataWithArena _internal_metadata_;
  ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr contect_;
  mutable ::PROTOBUF_NAMESPACE_ID::internal::CachedSize _cached_size_;
  friend struct ::TableStruct_msg_2eproto;
};
// ===================================================================
...
// string Contect = 1;
inline void Talk::clear_contect() {
  contect_.ClearToEmptyNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
}
inline const std::string& Talk::contect() const {
  // @@protoc_insertion_point(field_get:pb.Talk.Contect)
  return contect_.GetNoArena();
}
inline void Talk::set_contect(const std::string& value) {
  
  contect_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), value);
  // @@protoc_insertion_point(field_set:pb.Talk.Contect)
}
inline void Talk::set_contect(std::string&& value) {
  
  contect_.SetNoArena(
    &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::move(value));
  // @@protoc_insertion_point(field_set_rvalue:pb.Talk.Contect)
}
inline void Talk::set_contect(const char* value) {
  GOOGLE_DCHECK(value != nullptr);
  
  contect_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::string(value));
  // @@protoc_insertion_point(field_set_char:pb.Talk.Contect)
}
inline void Talk::set_contect(const char* value, size_t size) {
  
  contect_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      ::std::string(reinterpret_cast<const char*>(value), size));
  // @@protoc_insertion_point(field_set_pointer:pb.Talk.Contect)
}
inline std::string* Talk::mutable_contect() {
  
  // @@protoc_insertion_point(field_mutable:pb.Talk.Contect)
  return contect_.MutableNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
}
inline std::string* Talk::release_contect() {
  // @@protoc_insertion_point(field_release:pb.Talk.Contect)
  
  return contect_.ReleaseNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
}
inline void Talk::set_allocated_contect(std::string* contect) {
  if (contect != nullptr) {
    
  } else {
    
  }
  contect_.SetAllocatedNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), contect);
  // @@protoc_insertion_point(field_set_allocated:pb.Talk.Contect)
}
